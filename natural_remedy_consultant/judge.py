...
if __name__ == "__main__":
    ...
    question = "Is ginger safe to take with blood thinners?"
    answer = (
        "Ginger may have additive effects with anticoagulant medicines, "
        "so check with a clinician or pharmacist before using it in "
        "concentrated forms such as extracts or supplements."
    )
